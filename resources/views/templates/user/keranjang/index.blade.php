    ...
    <div class="container py-4">
        ...
        @else
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset($item->barang->gambar) }}" alt="{{ $item->barang->nama_barang }}"
                                            class="img-fluid" style="width: 70px; height: 70px; object-fit: cover;">
                                        <div class="ms-3">
                                ...
                                <td>
                                    <input type="number" value="{{ $item->jumlah }}" min="1" class="form-control"
                                        style="width: 70px;" onchange="updateQuantity({{ $item->id }}, this.value)">
                                </td>
            ...
            <div class="d-flex justify-content-end mt-4">
                <a href="{{ route('keranjang.checkout') }}" class="btn btn-primary">
